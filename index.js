    ...
    function changeMeasurement(listItem) {
        ...
        while (currentVal !== undefined) {
            if (text.includes(currentVal)) {
                ...
                const measurementUnitMultiplier =
                    measurements.get(currentVal)[0];
                let sum = 0;
                ...
                let newInnerText = text.replace(textToReplace, newText);
                newInnerText = newInnerText.replaceAll("\n", "");
